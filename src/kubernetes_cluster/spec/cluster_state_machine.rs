...
pub open spec fn kubernetes_api_next() -> Action<Self, Option<Message<E>>, ()> {
    let result = |input: Option<Message<E>>, s: Self| {
...
pub open spec fn controller_next() -> Action<Self, (Option<Message<E>>, Option<ObjectRef>), ()> {
    let result = |input: (Option<Message<E>>, Option<ObjectRef>), s: Self| {
    ...
    Action {
        precondition: |input: (Option<Message<E>>, Option<ObjectRef>), s: Self| {
        ...
        transition: |input: (Option<Message<E>>, Option<ObjectRef>), s: Self| {
...
pub open spec fn busy_kubernetes_api_rejects_request() -> Action<Self, Option<Message<E>>, ()> {
    let network_result = |input: Option<Message<E>>, s: Self| {
...
/// * whether to deliver a message and which message to deliver (`Option<Message<E>>` in `Step`)
...
pub open spec fn kubernetes_api_action_pre(action: KubernetesAPIAction<E>, input: Option<Message<E>>) -> StatePred<Self> {
    |s: Self| {
...
pub open spec fn builtin_controllers_action_pre(action: BuiltinControllersAction<E>, input: (BuiltinControllerChoice, ObjectRef)) -> StatePred<Self> {
    |s: Self| {
...
pub open spec fn controller_action_pre(action: ControllerAction<K, E, R>, input: (Option<Message<E>>, Option<ObjectRef>)) -> StatePred<Self> {
    |s: Self| {
