...
pub open spec fn handle_get_request(msg: Message<E>, s: KubernetesAPIState) -> (KubernetesAPIState, Message<E>)
    recommends
...
pub open spec fn handle_list_request(msg: Message<E>, s: KubernetesAPIState) -> (KubernetesAPIState, Message<E>)
    recommends
...
pub open spec fn handle_create_request(msg: Message<E>, s: KubernetesAPIState) -> (KubernetesAPIState, Message<E>)
    recommends
...
pub open spec fn handle_delete_request(msg: Message<E>, s: KubernetesAPIState) -> (KubernetesAPIState, Message<E>)
    recommends
...
pub open spec fn handle_update_request(msg: Message<E>, s: KubernetesAPIState) -> (KubernetesAPIState, Message<E>)
    recommends
...
pub open spec fn transition_by_etcd(msg: Message<E>, s: KubernetesAPIState) -> (KubernetesAPIState, Message<E>)
    recommends
...
pub open spec fn handle_request() -> KubernetesAPIAction<E> {
    Action {
        precondition: |input: KubernetesAPIActionInput<E>, s: KubernetesAPIState| {
            &&& input.recv.is_Some()
        ...
        transition: |input: KubernetesAPIActionInput<E>, s: KubernetesAPIState| {
...
pub open spec fn kubernetes_api() -> KubernetesAPIStateMachine<E> {
    StateMachine {
        ...
        action_input: |step: KubernetesAPIStep, input: KubernetesAPIActionInput<E>| {
            input
        }
    }
}
