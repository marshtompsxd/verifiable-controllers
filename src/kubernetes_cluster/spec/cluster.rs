...
pub struct Cluster<K: ResourceView, E: ExternalAPI, R: Reconciler<K, E>> {
    ...
    pub network_state: NetworkState<E>,
...
impl<K: ResourceView, E: ExternalAPI, R: Reconciler<K, E>> Cluster<K, E, R> {
    #[verifier(inline)]
    pub open spec fn message_in_flight(self, msg: Message<E>) -> bool {
    ...
    #[verifier(inline)]
    pub open spec fn pending_req_of(self, key: ObjectRef) -> Message<E>
        recommends
            self.reconcile_state_contains(key),
