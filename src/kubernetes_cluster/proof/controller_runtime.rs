...
pub open spec fn pending_k8s_api_req_msg_is(s: Self, key: ObjectRef, req: Message<E>) -> bool {
...
pub open spec fn request_sent_by_controller(msg: Message<E>) -> bool {
...
pub open spec fn req_msg_is_the_in_flight_pending_req_at_reconcile_state(
    key: ObjectRef, state: FnSpec(R::T) -> bool, req_msg: Message<E>
) -> StatePred<Self> {
    |s: Self| {
        Self::at_expected_reconcile_states(key, state)(s)
