        ...
        valid(stable(Self::sm_partial_spec())),
{
    ...
    Self::tla_forall_action_weak_fairness_is_stable::<Option<Message<E>>, ()>(Self::kubernetes_api_next());
    Self::tla_forall_action_weak_fairness_is_stable::<(BuiltinControllerChoice, ObjectRef), ()>(Self::builtin_controllers_next());
    Self::tla_forall_action_weak_fairness_is_stable::<(Option<Message<E>>, Option<ObjectRef>), ()>(Self::controller_next());
