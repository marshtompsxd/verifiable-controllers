...
pub open spec fn reconciler_at_after_get_cr_pc_and_pending_req(msg: Message<E>, cr: SimpleCRView) -> StatePred<State<SimpleReconcileState>> {
    |s: State<SimpleReconcileState>| {
        &&& s.reconcile_state_contains(cr.object_ref())
        &&& s.reconcile_state_of(cr.object_ref()).local_state.reconcile_pc == reconciler::after_get_cr_pc()
...
pub open spec fn reconciler_at_after_get_cr_pc_and_ok_resp_with_name_and_namespace_in_flight(req_msg: Message<E>, cr: SimpleCRView) -> StatePred<State<SimpleReconcileState>> {
    |s: State<SimpleReconcileState>| {
        &&& s.reconcile_state_contains(cr.object_ref())
        &&& s.reconcile_state_of(cr.object_ref()).local_state.reconcile_pc == reconciler::after_get_cr_pc()
...
pub open spec fn reconciler_at_after_get_cr_pc_and_pending_req_in_flight_and_no_resp_in_flight(req_msg: Message<E>, cr: SimpleCRView) -> StatePred<State<SimpleReconcileState>> {
    |s: State<SimpleReconcileState>| {
        &&& s.reconcile_state_contains(cr.object_ref())
        &&& s.reconcile_state_of(cr.object_ref()).local_state.reconcile_pc == reconciler::after_get_cr_pc()
        &&& s.reconcile_state_of(cr.object_ref()).pending_req_msg == Some(req_msg)
...
pub open spec fn reconciler_at_after_get_cr_pc_and_pending_req_and_req_in_flight(msg: Message<E>, cr: SimpleCRView) -> StatePred<State<SimpleReconcileState>> {
    |s: State<SimpleReconcileState>| {
        &&& s.reconcile_state_contains(cr.object_ref())
        &&& s.reconcile_state_of(cr.object_ref()).local_state.reconcile_pc == reconciler::after_get_cr_pc()
...
pub open spec fn reconciler_at_after_get_cr_pc_and_pending_req_and_exists_resp_in_flight(msg: Message<E>, cr: SimpleCRView) -> StatePred<State<SimpleReconcileState>> {
    |s: State<SimpleReconcileState>| {
        &&& s.reconcile_state_contains(cr.object_ref())
        &&& s.reconcile_state_of(cr.object_ref()).local_state.reconcile_pc == reconciler::after_get_cr_pc()
        &&& s.reconcile_state_of(cr.object_ref()).pending_req_msg == Some(msg)
...
pub open spec fn reconciler_at_after_get_cr_pc_and_pending_req_and_resp_in_flight(req_msg: Message<E>, resp_msg: Message<E>, cr: SimpleCRView) -> StatePred<State<SimpleReconcileState>> {
    |s: State<SimpleReconcileState>| {
        &&& s.reconcile_state_contains(cr.object_ref())
        &&& s.reconcile_state_of(cr.object_ref()).local_state.reconcile_pc == reconciler::after_get_cr_pc()
        &&& s.reconcile_state_of(cr.object_ref()).pending_req_msg == Some(req_msg)
...
pub open spec fn is_controller_get_cr_request_msg(msg: Message<E>, cr: SimpleCRView) -> bool {
...
pub open spec fn is_controller_create_cm_request_msg(msg: Message<E>, cr: SimpleCRView) -> bool {
    &&& msg.src == HostId::CustomController
    &&& msg.dst == HostId::KubernetesAPI
