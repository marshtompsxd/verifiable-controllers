...
pub open spec fn req_msg_is_the_in_flight_pending_req_at_zookeeper_step_with_zk(
    step: ZookeeperReconcileStep, zk: ZookeeperClusterView, req_msg: Message<E>, object: DynamicObjectView
) -> StatePred<ZKCluster> {
    |s: ZKCluster| {
        &&& at_zookeeper_step_with_zk(zk, step)(s)
...
pub open spec fn resp_msg_is_the_in_flight_resp_at_zookeeper_step_with_zk(
    step: ZookeeperReconcileStep, zk: ZookeeperClusterView, resp_msg: Message<E>, object: DynamicObjectView
) -> StatePred<ZKCluster> {
    |s: ZKCluster| {
        &&& at_zookeeper_step_with_zk(zk, step)(s)
        &&& ZKCluster::pending_k8s_api_req_msg(s, zk.object_ref())
...
pub open spec fn is_correct_pending_request_msg_at_zookeeper_step(
    step: ZookeeperReconcileStep, msg: Message<E>, zk: ZookeeperClusterView, object: DynamicObjectView
) -> bool {
